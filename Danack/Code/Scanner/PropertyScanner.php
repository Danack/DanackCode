...
namespace Danack\Code\Scanner;

use Danack\Code\Annotation;
use Danack\Code\Exception;
use Danack\Code\NameInformation;
...
class PropertyScanner implements ScannerInterface
{
     ...
     * Scan tokens
     *
     * @throws \Danack\Code\Exception\RuntimeException
     */
